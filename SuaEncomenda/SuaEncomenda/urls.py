"""SuaEncomenda URL Configuration
...
urlpatterns = [
    path('', include('AppSuaEncomenda.urls')),
    path('registrar/', accountsViews.registrar, name='registrar'),
    ...
    path('perfil/', accountsViews.perfil, name='perfil'),
